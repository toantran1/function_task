...
<body class="">
            ...
            <div class="flex flex-col h-full gap-4">
                <div class="mb-8 text-center lg:text-start">
                    <a href="index" class="flex justify-center lg:justify-start">
                        <img src="{!! asset('images/logo.png') !!}" alt="logo" class="h-6 hidden dark:block">
                        <img src="{!! asset('images/logo-dark.png') !!}" alt="logo" class="h-6 block dark:hidden">
                    </a>
                </div>
                <div class="my-auto">
                    <!-- title-->
                    ...
                    <form method="POST" action="{{ route('login.post') }}">
                        ...
                        <div class="mb-6 space-y-2">
                            ...
                            <input class="form-input" type="email" name="email" id="emailaddress" required="" placeholder="Enter your email">
                        </div>
                        <div class="mb-6 space-y-2">
                ...
                <footer class="text-center justify-center h-14 -mb-12">
                    <p class="text-gray-400">Don't have an account? <a href="{{ url('admin/register') }}" class="text-gray-500 ms-1"><b>Sign Up</b></a></p>
                </footer>
            </div>
        </div>
    ...
    <!-- Swiper Auth Demo Js -->
    <script src="{!! asset('js/pages/auth-swiper.js') !!}"></script>
